...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from customer where meter="+generate);
            ...
            rs = c.s.executeQuery("select * from meter_info where meter_number = " + generate);
            ...
            rs = c.s.executeQuery("select * from bill where meter="+generate+" AND month = '"+c2.getSelectedItem()+"'");
